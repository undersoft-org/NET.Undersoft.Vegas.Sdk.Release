...
namespace System.Sets
{
    ...
    /// <summary>
    /// Defines the <see cref="BaseMassDeck{V}" />.
    /// </summary>
    /// <typeparam name="V">.</typeparam>
    public abstract class BaseMassDeck<V> : SeededSet<V> where V : IUnique
    {
        #region Constructors
        ...
        public BaseMassDeck(IEnumerable<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public BaseMassDeck(IList<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public BaseMassDeck(IList<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        ...
        /// <param name="capacity">The capacity<see cref="int"/>.</param>
        /// <param name="bits">The bits<see cref="HashBits"/>.</param>
        public BaseMassDeck(int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {
        }
